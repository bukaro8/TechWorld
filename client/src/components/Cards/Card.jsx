        ...
        <div class="container mx-auto p-6 ">
            <a key={id} href={id}>
                <div className='flex items-stretch -mx-4 h-full'>
                    <div className=" m-8 w-72 max-w-sm bg-white rounded-lg shadow-md dark:bg-slate-300 dark:border-gray-700 ">
                        ...
                        <div class="px-5 pb-5 ">
                            ...
                            descripcion:
                            dolor sit amet, consectetur adipisicing elit. Voluptatibus quia</p>*/
                            }
                        </div>
                    </div>
                </div>
