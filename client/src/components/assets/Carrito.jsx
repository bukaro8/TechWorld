														...
														<div class='mt-8'>
															<div class='flow-root'>
																<ul class='-my-6 divide-y divide-gray-200'>
																	<li class='flex py-6'>
																		<div class='h-24 w-24 flex-shrink-0 flex justify-center overflow-hidden rounded-md border border-gray-200'>
																			<img
																				className='max-w-full'
																				src={e.image}
																				alt='Salmon orange fabric pouch with match zipper, gray zipper pull, and adjustable hip belt.'
																				class='h-full max-w-full text-center'
																			/>
																		</div>
