...
export default function EditProduct() {
	...
	function actProduct() {
		...
		Swal(' sussenfull', 'the product was edited', 'success');
		setTimeout(() => {
			history.push('/list');
		}, '1500');
	}
	...
	return (
		<div>
			<Link to='/list' className=' m-2 rounded p-2 '>
				<button>❌</button>
			</Link>
			<form
                ...
                <div className="mb-5 grid justify-items-end"> */}
					...
					<span>
						...
						{estado === false ? (
							...
							<span className='text-lime-500 font-bold text-4xl  '>Activo</span>
						)}
					</span>
					{/* </div>
                <div className="mb-5 grid justify-items-end"> */}
					<select
						...
						className='border w-80 p-2 mt-2 placeholder-gray-400 rounded-md text-xl '
					>
						<option>seleccione un estado</option>
						<option value='true' className='text-lime-500 font-bold text-2xl'>
							activo
						</option>
						<option value='false' className='text-red-500 font-bold text-2xl'>
							inactivo
						</option>
					</select>
				</div>
