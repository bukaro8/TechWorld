...
export default function Home({}) {
	...
	return (
		<div>
			...
			<footer className='p-4 mt-3 bg-white rounded-lg shadow md:flex md:items-center justify-center md:p-6 '>
				<span className='text-sm  text-center'>
					© 2023{' '}
					<a href='/team' className='hover:underline hover:text-red-600'>
						TechWorld™
					</a>
					. All Rights Reserved.
				</span>
