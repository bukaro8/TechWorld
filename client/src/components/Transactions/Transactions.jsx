	...
	return (
		<div className='flex justify-around flex-wrap m-2'>
			...
			<button
				...
				type='submit'
				className='text-white block bg-blue-500 hover:bg-blue-600 hover:text-red-700 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4'
			>
				Search
			</button>
			<select
			...
			{!searchMail.length ? (
				...
				<table className='table-auto border-2 border-indigo-500 m-2'>
					<thead className='border-2 border-indigo-500'>
						<tr>
							<th className='border-2 border-indigo-500 p-1'>Transaction ID</th>
							<th className='border-2 border-indigo-500 p-1'>Email</th>
							<th className='border-2 border-indigo-500 p-1'>Amount</th>
							<th className='border-2 border-indigo-500 p-1'>Status</th>
							<th className='border-2 border-indigo-500 p-1'>Delivered</th>
						</tr>
					</thead>
					<tbody>
						{searchMail.map((e) => {
							return (
								<tr>
									<td className='border-2 border-indigo-500 p-1'>{e._id}</td>
									<td className='border-2 border-indigo-500 p-1'>
										{e.userEmail}
									</td>
									<td className='border-2 border-indigo-500 p-1'>${e.price}</td>
									<td className='border-2 border-indigo-500 p-1'>
										<button
