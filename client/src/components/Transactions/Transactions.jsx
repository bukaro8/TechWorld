...
export default function Transactions(){
    ...
    return (
        <div class="flex justify-around flex-wrap m-2">
            ...
            <select onChange={e => {handleStatus(e)}} class="bg-gray-50 mt-2 mx-2 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-44 p-2.5">
                <option value="Filter by status" disabled selected defaultValue>Filter by status</option>
