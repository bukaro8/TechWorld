        ...
        <div class="flex justify-around flex-wrap m-2">
                {!searchMail.length ? (
                    ...
                    <thead class="border-2 border-indigo-500">
                        ...
                        <th class="border-2 border-indigo-500 p-1 text-center">Amount of Items</th>
                        <th class="border-2 border-indigo-500 p-1 text-center">Amount</th>
                        <th class="border-2 border-indigo-500 p-1 text-center">Payment Status</th>
                    ...
                    <tbody>
                        ...
                        return (
                            ...
                            <td class="border-2 border-indigo-500 p-1 text-center">{e.itemsBought.length}</td>
