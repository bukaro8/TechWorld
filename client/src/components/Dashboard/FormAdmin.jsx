...
export default function FormAdmin() {
	...
	return (
		<div className=''>
			<Link
				to='/'
				className='bg-blue-700 m-2 rounded p-2 '

				// <Link to='/' className=" text-white p-24  bg-blue-500 hover:bg-blue-600 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 "
			>
			...
			<div className=''>
				...
				<form onSubmit={(e) => handleSubmit(e)} className=''>
					<section className='mx-40'>
						{/* <section className="flex flex-wrap -mx-1 mb-1"> */}
					...
					<button
						className='bg-slate-500 m-2 rounded p-2 mt-10 bg-red-700'
						type='submit'
					>
						Crear User
					</button>
