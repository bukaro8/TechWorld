			...
			<div className='text-center w-1/4'>
				...
				<div className=''>
					{!user ? (
						<div>
							...
							<PayPalScriptProvider
								options={{
									'client-id':
										'AQB3R_3UZ3vTt2ldgt4HbNje7Ms7fDH5MP9tbok-zjN6DeuRGw5Z2ommnuZ-ERXDlWT3Ucv9ozPMnfrl',
								}}
							>
					...
					<div className='flex flex-col justify-center items-center'>
						<button className='w-8' onClick={cleanCartAlert}>
							<img
